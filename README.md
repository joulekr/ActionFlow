![logo](/docs/img/actionflow.png)

# ActionFlow

> **Windows용 키보드 중심 런처 & 생산성 도구**  
> A keyboard-driven launcher and productivity tool for Windows, built with Tauri v2 + Rust + React.

![.](https://img.shields.io/badge/platform-Windows-blue?logo=windows)
[![GitHub release](https://img.shields.io/github/v/release/joulekr/ActionFlow?style=flat-square)](https://github.com/joulekr/PasteWin/releases/latest)
